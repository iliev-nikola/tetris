...
const figure1 = [
	...
	[{x: 2, y: 1}, {x: 1, y: 0}, {x: 1, y: 1}, {x: 0, y: 1}],
...
const figure2 = [
	...
	[{x: 2, y: 2}, {x: 1, y: 0}, {x: 1, y: 1}, {x: 1, y: 2}],
	[{x: 3, y: 0}, {x: 2, y: 0}, {x: 1, y: 0}, {x: 1, y: 1}]
];
     //
//////
const figure3 = [
	[{x: 2, y: 0}, {x: 2, y: 1}, {x: 2, y: 2}, {x: 1, y: 2}],
	[{x: 2, y: 1}, {x: 1, y: 1}, {x: 0, y: 0}, {x: 0, y: 1}],
	[{x: 2, y: 0}, {x: 1, y: 0}, {x: 1, y: 1}, {x: 1, y: 2}],
	[{x: 2, y: 0}, {x: 2, y: 1}, {x: 1, y: 0}, {x: 0, y: 0}]
];
////////
const figure4 = [
...
const figure5 = [
	...
	[{x: 2, y: 1}, {x: 1, y: 0}, {x: 1, y: 1}, {x: 0, y: 0}]
];
////
  ////
const figure6 = [
	[{x: 1, y: 1}, {x: 1, y: 2}, {x: 0, y: 0}, {x: 0, y: 1}],
